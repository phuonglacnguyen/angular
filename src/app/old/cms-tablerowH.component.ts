...
@Component({
  selector: 'app-cms-tablerowH',
  templateUrl: './cms-tablerowH.component.html',
  styleUrls: ['./cms-tablerowH.component.css']
})

@Injectable()
export class CmsTablerowHComponent { // implements AfterViewInit
    @Input() cmsPages;
    @Input() userlogin;
    @Input() currentPage;
